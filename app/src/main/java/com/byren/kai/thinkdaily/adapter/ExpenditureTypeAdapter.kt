...
import kotlinx.android.synthetic.main.expendituretype_item.view.*

/**
 * Created by Lucas on 2018/3/28 .
 * 支出类型适配器
 */
class ExpenditureTypeAdapter(activity: Activity, list: ArrayList<String>, val onClick: (View, Int) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return IncometypeHolder(LayoutInflater.from(context).inflate(R.layout.expendituretype_item, parent, false))
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        setIcon(holder.itemView.tv_addbill_expendituretype_item, holder.itemView.iv_addbill_expendituretype_item, position)
    ...
    class IncometypeHolder(view: View) : RecyclerView.ViewHolder(view) {
        private val tv: TextView = view.findViewById(R.id.tv_addbill_expendituretype_item)
        private val iv: ImageView = view.findViewById(R.id.iv_addbill_expendituretype_item)
